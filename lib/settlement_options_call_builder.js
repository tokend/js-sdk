...
var SettlementOptionsCallBuilder = exports.SettlementOptionsCallBuilder = (function (_CallBuilder) {
  ...
  _createClass(SettlementOptionsCallBuilder, {
    ...
    saleId: {
      value: (function (_saleId) {
        var _saleIdWrapper = function saleId(_x) {
          return _saleId.apply(this, arguments);
        };

        _saleIdWrapper.toString = function () {
          return _saleId.toString();
        };

        return _saleIdWrapper;
      })(function (saleId) {
